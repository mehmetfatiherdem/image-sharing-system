...
*/
                ...
                /*
                    ...
                    System.out.println("MAC key: " + " " + Arrays.toString(messageKeyValues.get("macKey").getBytes()));
                    System.out.println("Secret message: " + " " + messageKeyValues.get("secretMessage"));
                    System.out.println("decrypted: " + Arrays.toString(Confidentiality.decryptWithPrivateKey(messageKeyValues.get("macKey").getBytes(),
                            serverRepository.getPrivateKey())));
                    /*
                    var mac = Confidentiality.decryptWithPrivateKey(messageKeyValues.get("macKey").getBytes(),
                            serverRepository.getPrivateKey());

                    MAC = Authentication.generateMAC(Confidentiality.decodeStringKeyToByteBase64(messageKeyValues.get("secretMessage")),
                            mac);
                    System.out.println("MAC generated by server: " + " " + Arrays.toString(MAC));
