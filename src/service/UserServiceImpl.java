...
public class UserServiceImpl implements UserService {
    ...
    public void postImage(String imageName, String imagePath) {
        try {
            ...
            var sessionMsg = Message.formatMessage("SESSIONID", new String[]{"mac", "sessionID", "ip"},
                    new String[]{Confidentiality.encodeByteKeyToStringBase64(hmacGlobal),
                            Confidentiality.encodeByteKeyToStringBase64(encryptedSessionID), IP});

            System.out.println("[client] session id sent post image: " + sessionID);

            out.writeUTF(sessionMsg);
